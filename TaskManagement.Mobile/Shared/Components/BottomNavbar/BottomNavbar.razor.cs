    ...
    {    
        ...
        public async Task RenderMenuItems() 
        {
            ...
            {   
                ...
                new MenuBarItem  { TabName = "", Link ="/add-task-modal" , Icon= Icons.Material.Filled.AddCircle , IconSize = MudBlazor.Size.Large , Color = MudBlazor.Color.Primary },
